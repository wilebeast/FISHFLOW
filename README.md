...
- 后台管理账号、库存/卡密池、商品、会话、模板、规则、通知、审计、AI 回复、AI 文案中心、知识库、报表和设置
- 后台可执行最小操作：人工接管、手动发送消息、规则启停、模板启停、发货重试、账号健康检查、库存分配、通知测试、AI 回复测试、AI 文案生成、知识库维护、设置导入导出
...
### 演示 6：AI 文案中心 / 知识库 / 报表 / 设置

1. 打开 `AI Copy`，生成一条标题或描述文案
2. 打开 `Knowledge`，维护 FAQ 知识条目
3. 打开 `Analytics`，查看概览和历史快照
4. 打开 `Settings`，保存一项配置并导出
...
它已经证明账号、库存、商品、会话、订单、消息、发货任务、规则、模板、通知、AI 回复、AI 文案、知识库、报表和设置这些核心流程能跑，但还没有进入真实闲鱼联调和商业化可交付阶段。
