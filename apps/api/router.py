...
from interfaces.http.routers.ai_copy import router as ai_copy_router
from interfaces.http.routers.ai_reply import router as ai_reply_router
from interfaces.http.routers.analytics import router as analytics_router
...
from interfaces.http.routers.settings import router as settings_router
...
api_router.include_router(ai_copy_router, prefix="/ai/copy", tags=["ai-copy"])
